...
function editTask(id, name, description) {
    ...
    if ( !formReference.children[0] ) {
        ...
        let formAdd = document.getElementById("AddTask");
...
function editSubTask(id, name, description) {
...
function deleteSubTask(id, name, description) {
